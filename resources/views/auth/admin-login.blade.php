...
/* =========================================================================
        ...
        *, *::before, *::after {
        ...
        /* Repère visuel réservé à l'espace d'administration. */
            ...
            <form action="{{ route('admin.login.submit') }}" method="POST">
                ...
                <div class="field">
                    ...
                    <div class="field-input @error('password') is-invalid @enderror">
                        ...
                        <button type="button" class="toggle-pass" onclick="toggleAdminPassword()" aria-label="Afficher ou masquer le mot de passe"><i id="togglePasswordIcon" class="fas fa-eye"></i></button>
                    </div>
