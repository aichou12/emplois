    ...
    <div class="container-fluid">
        ...
        <div class="container">
          <div class="page-inner">
            ...
            >
              <div>   
                <h3 class="fw-bold mb-3"><i class="fas fa-home"></i><a href="/demandeur_feminin" class="btn-choose-theme">
...
<div class="sticky-wrapper" style=""><nav class="navbar navbar-default" role="navigation" style="width: auto;">
 ...
 <li><a class="sonata-action-element" href="/demandeur_feminin"><i class="fa fa-list" aria-hidden="true"></i>
...
@endif
 ...
 <div class="col-md-12">
                ...
                <div class="card-body">
                <form action="{{ route('admin.updatefeminin', $utilisateur->id) }}" method="POST">
