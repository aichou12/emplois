    ...
    <div class="container-fluid">
        ...
        <div class="container">
          <div class="page-inner">
            ...
            >
              <div>
                <h3 class="fw-bold mb-3"><i class="fas fa-home"></i><a href="{{ route('liste.feminin') }}" class="btn-choose-theme">
...
<div class="sticky-wrapper" style=""><nav class="navbar navbar-default" role="navigation" style="width: auto;">
 <div class="container-fluid">
    ...
    <div class="navbar-collapse">
        ...
        <li>
  <a class="sonata-action-element d-flex align-items-center" href="{{ route('liste.feminin') }}">
...
@endif
 ...
 <div class="col-md-12">
  ...
  Éditer les informations de l'utilisateur
                ...
                <div class="card-body">
                <form id="updateForm" action="{{ route('admin.updatefeminin', $utilisateur->id) }}" method="POST">
        @csrf
        @method('PUT')
                        <div class="row">
                            <div class="col-md-6">
