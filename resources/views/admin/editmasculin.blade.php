...
<div class="sticky-wrapper" style=""><nav class="navbar navbar-default" role="navigation" style="width: auto;">
 ...
 <li><a class="sonata-action-element" href="/demandeur_masculin"><i class="fa fa-list" aria-hidden="true"></i>
...
@endif
 ...
 <div class="col-md-12">
                ...
                <div class="card-body">
                <form action="{{ route('admin.updatemasculin', $utilisateur->id) }}" method="POST">
