    ...
    <div class="container-fluid">
        ...
        <div class="container">
          <div class="page-inner">
            ...
            >
              <div>
                <h3 class="fw-bold mb-3"><i class="fas fa-home"></i><a href="/compteactif" class="btn-choose-theme">
...
<div class="sticky-wrapper" style=""><nav class="navbar navbar-default" role="navigation" style="width: auto;">
 <div class="container-fluid">
    ...
    <div class="navbar-collapse">
        ...
        <li>
  <a class="sonata-action-element d-flex align-items-center" href="/compteactif">
