   ...
   <div class="main-panel">
       ...
       <div class="container">
           <div class="page-inner">
               ...
               <form action="{{ route('liste.feminin') }}" method="GET" class="mt-3">
   ...
   if (e.target.type === 'checkbox') {
     ...
     if (e.target.checked) {
       ...
       if (existingField) existingField.remove();
               ...
               <h1 style= text-align:center>Liste des demandeurs feminins</h1>
                   ...
                   <table class="table table-striped table-bordered table-hover" id="mainUserTable">
                       ...
                       <tbody>
                           ...
                           <tr>
                               ...
                               <td>
                                   <a href="{{ route('admin.editfeminin', $u->id) }}" class="btn btn-success">
