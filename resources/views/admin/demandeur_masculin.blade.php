...
<h2 class="mb-4">Liste des demandeurs masculins</h2>

@if($demandeursMasculins->isEmpty())
        <div class="alert alert-warning">
            Aucun demandeur masculin trouvé.
        </div>
    @else
<table class="table table-striped table-bordered table-hover"  id="mainUserTable">
    ...
    <tbody>
    @foreach($demandeursMasculins as $demandeur)
    <tr>
   ...
   <td>
   <a href="{{ route('admin.editmasculin', $utilisateur->id) }}" class="btn btn-success">
